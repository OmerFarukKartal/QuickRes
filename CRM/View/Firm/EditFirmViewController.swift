...
class EditFirmViewController: UIViewController, UITextViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var firmInfo : Firm?
    var viewModel = UpdateFirmViewModel(networkManager: .shared)
    ...
    private func configureTextFields() {
        guard let firm = firmInfo else { return }
        firmNameTextField.text = "\(String(describing: firm.name))"
        emailTextField.text = "\(firm.email )"
        phoneTextField.text = "\(firm.phone )"
        websiteTextField.text = "\(firm.webSite)"
        taxOfficeTextField.text = "\(String(describing: firm.taxOffice))"
        taxNumberTextField.text = "\(firm.taxNumber)"
        townTextField.text = "\(String(describing: firm.district))"
        employeeCountTextField.text = "\(firm.numberOfEmployees)"
        postCodeTextField.text = "\(firm.postCode)"
        linkedInTextField.text = "\(firm.linkedin)"
        instagramTextField.text = "\(firm.instagram)"
        addressTextView.text = "\(String(describing: firm.adress))"
        descriptionTextView.text = "\(String(describing: firm.description))"
        cityTextField.placeholder = "\(firm.city.description)"
        firmAreaTextField.placeholder = "\(firm.activityArea.description)"
        firmTypeTextField.text = "\(firm.businessType.description)"
    }
